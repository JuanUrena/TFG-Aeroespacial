...
*option RMIP=CONOPT;
         ...
         execute "gams main_duty_branch_and_price.gms %ide%";
...
*    execute "gams generate_duty_DUAL.gms %ide%";
    execute "gams generate_duty.gms %ide%";
    execute_load 'Select_D' used_d_g=Selected_duty2.l;
...
*     Selected_duty_comb(D)$Selected_duty.l(D)=0;
        ...
        if (now,
         ...
         duties_test(D, F)$((ord(D)=d_act) and S(F)=1)=1;
